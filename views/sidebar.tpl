			...
			<div class="aside-menu flex-column-fluid ps-5 pe-3 mb-9" id="kt_aside_menu">
				...
				<div class="w-100 hover-scroll-overlay-y d-flex pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu, #kt_aside_menu_wrapper" data-kt-scroll-offset="100">
					...
					<div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
							...
							<div class="menu-sub menu-sub-accordion">
								<div class="menu-item">
									<a class="menu-link" href="#">
										...
										<span class="menu-title">null</span>
									</a>
								</div>
							</div>
						</div>
						...
						<div class="menu-item">
							<a class="menu-link active" href="/admin/users">
								<span class="menu-icon">
									<!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
									<span class="svg-icon svg-icon-5">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
						...
						<div class="menu-item">
							<a class="menu-link active" href="/admin/roles">
								<span class="menu-icon">
									<!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
									<span class="svg-icon svg-icon-5">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
			...
			<div class="aside-footer flex-column-auto px-9" id="kt_aside_footer">
				...
				<div class="d-flex flex-stack">
					...
					<div class="d-flex align-items-center">
						...
						<div class="ms-2">
							<!--begin::Name-->
							<a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder lh-1">{{ .Userinfo.Username}}</a>
							<!--end::Name-->
							<!--begin::Major-->
							<span class="text-muted fw-bold d-block fs-7 lh-1">{{ .Userinfo.Roles}}</span>
							<!--end::Major-->
						</div>
						<!--end::User info-->
					</div>
							...
							<div class="menu-item px-3">
								<div class="menu-content d-flex align-items-center px-3">
									...
									<div class="d-flex flex-column">
										...
										<a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ .Userinfo.Email}}</a>
									</div>
									<!--end::Username-->
								</div>
							</div>
